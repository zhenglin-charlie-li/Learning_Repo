 ...
 * @see DVDMovie
 */
public class TestDVDMovie extends DVDMovie {

	public TestDVDMovie(String initialTitle , String[] initialActors , String initialDirector ,
						int initialRegionCode , String[] initialAudioTracks , String[] initialSubtitles){
		super(initialTitle , initialActors , initialDirector ,
		initialRegionCode ,  initialAudioTracks ,initialSubtitles);
	}
